...
#region Process info.plist
            ...
            if (appleBuildProfile.AutomateInfoPlist)
            {
                ...
                // Deployment OS target...
                if (!string.IsNullOrEmpty(appleBuildProfile.MinimumOSVersion))
                {
                    infoPlist.root.SetString("LSMinimumSystemVersion", appleBuildProfile.MinimumOSVersion);
                }
